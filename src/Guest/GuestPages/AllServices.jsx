...
export default function OurService() {
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto p-8">
            <div id="title" className='pb-7 text-center inline-block justify-center items-center flex'>
                <div className=" flex-1 rounded-md ml-10 mr-10 inline-block"
                    ...
                    <h1 className="text-5xl font-bold uppercase bg-accent p-2 rounded">
                        Our <span className='text-[#266D53]'>Services</span>
                    </h1>
                </div>
            </div>
            ...
            <div id="cards" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                {currentProcedures.map(procedure => (
                    <div key={procedure._id} className="card card-compact bg-white shadow-lg rounded-lg">
                        ...
                        <div className="card-body p-4">
                            <h2 className="card-title text-xl text-[#266D53] text-center justify-center font-semibold">{procedure.Procedure_name}</h2>
                        </div>
                    </div>
                ))}
            </div>
