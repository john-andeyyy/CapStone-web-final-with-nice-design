...
const Teethmodel = ({ status, id, name, onClick, notes }) => {
    ...
    const toothColors = {
        ...
        Extracted: { base: '#000000', hover: '#808080' },    // Black for extracted 
    ...
    if (status === 'Extracted') {
        toothColor = toothColors.Extracted.base;
    } else {
        toothColor = toothColors.default.base;
        ...
        <div className='flex flex-col items-center'>
            <div className='w-20 h-w-20 '>
                ...
                >
                    ...
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#000000" strokeWidth="23.256">
                        <g>
